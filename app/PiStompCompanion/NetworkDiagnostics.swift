...
enum NetworkDiagnostics {
    ...
    private static func shmSection(snap: Shm, attached: Bool, error: String?) -> String {
        ...
        let rows: [(String, UInt64)] = [
            ...
            ("dupReadCycles 0x280", snap.dupReadCycles),
            ("skipReadFrames 0x288", snap.skipReadFrames),
            ("dupWriteCycles 0x290", snap.dupWriteCycles),
            ("skipWriteFrames 0x298", snap.skipWriteFrames),
            ("recvResyncs 0x2a0", snap.recvResyncs),
